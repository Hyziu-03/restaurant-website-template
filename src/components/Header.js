...
// ? const changeTheme = () => { try { localStorage.getItem('theme') === 'light' ? localStorage.setItem('theme', 'dark') : localStorage.setItem('theme', 'light'); loadStylesheet(); } catch (exception) { throw new Error(exception); } }
